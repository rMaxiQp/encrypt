...
const static int IP_Table_Inv[64] = {
...
const static int S_BOX[8][4][16] = {
  {//S_1
    {14, 4, 13, 12, 15, 11, 8, 3, 10, 6, 1, 2, 5, 9, 0, 7},
    {15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 1, 1, 9, 5, 3, 8},
    {4, 11, 4, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 1, 0, 50},
    {15, 12, 8, 2, 4, 9, 1, 7, 5, 1, 13, 14, 10, 0, 6, 13}
  },
  {//S_2
  ...
  {//S_3
    {10, 0, 9, 14, 16, 3, 15, 5, 1, 13, 12, 7, 11, 4, 2, 8},
  ...
  {//S_5
    {2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 5, 13, 0, 14, 9},
  ...
  {//S_7
    ...
    {13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 5},
  ...
  {//S_8
    ...
    {2, 1, 14, 7, 4, 0, 6, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11}
  }
};
